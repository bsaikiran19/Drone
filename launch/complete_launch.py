...
def generate_launch_description():
    ...
    world_file = os.path.join(pkg_share, "worlds", "benchmark_world.sdf")
        ...
        actions=[
            ExecuteProcess(
                cmd=[
                    ...
                    # ── V5 additions: depth + camera_info from the front
                    # rgbd_camera sensor, and IMU. Point cloud
                    # (/camera/front/points) intentionally not bridged —
                    # NavigationCore only needs the depth image, and
                    # skipping the point cloud bridge saves ROS bandwidth
                    # on WSL2.
        ...
        actions=[
            Node(
                ...
                remappings=[
                    ...
                    ('/drone/front_camera/image_raw', '/camera/front/image'),
                    ('/drone/front_camera/depth_image', '/camera/front/depth_image'),
                    ('/drone/front_camera/camera_info', '/camera/front/camera_info'),
